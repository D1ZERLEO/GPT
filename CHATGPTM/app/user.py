...
from aiogram.types import Message, InlineKeyboardButton, InlineKeyboardMarkup, CallbackQuery, ContentType, ReplyKeyboardMarkup, KeyboardButton
...
@user.message(F.text == "Выбрать модель")
